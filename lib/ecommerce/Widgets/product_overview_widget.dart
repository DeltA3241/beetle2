    ...
    return ClipRRect(
      ...
      child: GridTile(
             child: GestureDetector(
                 child: Image.network(products.imgurl, fit: BoxFit.cover,),
                 onTap:(){
